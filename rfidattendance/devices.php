...
<main>
	<h1 class="slideInDown animated">Add a new organisation</h1>
	...
	<section class="container py-lg-5">
		...
		<div class="row">
			<div class="col-lg-12 mt-4">
				<div class="panel">
			      <div class="panel-heading" style="font-size: 19px;">Organisations Listed:
			      	<button type="button" class="btn btn-success" data-toggle="modal" data-target="#new-device" style="font-size: 18px; float: right; margin-top: -6px;">Add Organisation</button>
			      </div>
